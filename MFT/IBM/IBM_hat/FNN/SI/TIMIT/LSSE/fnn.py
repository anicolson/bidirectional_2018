...
# BRIEF:          Estimates the LSSE-IBM mask using a Feedforward Neural Network (FNN).
...
save_path = '/home/aaron/feat/MFT/IBM/IBM_hat/FNN/SI/TIMIT/LSSE/' + version # save path for output test files.
model_path = '/home/aaron/model/MFT/IBM/IBM_hat/FNN/SI/TIMIT/LSSE/' + version # model save path.
